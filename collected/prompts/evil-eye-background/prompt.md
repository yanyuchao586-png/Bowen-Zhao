> Source: https://www.reactbits.dev/backgrounds/evil-eye?glowIntensity=0.3&flameSpeed=0.9
> Collection note: prompt preserved for learning and remixing. Check the source site's license and terms before reusing source assets or code.

## Integrate the <EvilEye /> component from React Bits
